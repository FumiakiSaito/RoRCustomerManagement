...
describe Staff::Authenticator do
  describe '#authenticate' do
    ...
    example '正しいパスワードならtrueを返す' do
      m = build(:staff_member) # このstaff_memberはspec/factories/staff_memberのオブジェクトが返ってくる
    ...
    example 'パスワード未設定ならfalseを返す' do
      m = build(:staff_member, password: nil) # このstaff_memberはspec/factories/staff_memberのオブジェクト、passwordはnillでオブジェクトが作られる
